...
def get_latest_input(state):
    ...
    return {
        ...
        "phone": str(last_row["phone no"])  # 👈 ADD
    }
...
graph.add_edge("send_email", "save_to_supabase")       # 👈 CHANGED
graph.add_edge("save_to_supabase", END)                # 👈 ADD
